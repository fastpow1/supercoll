...
pkgdatadir = $(datadir)/collectiblecoincore
pkgincludedir = $(includedir)/collectiblecoincore
pkglibdir = $(libdir)/collectiblecoincore
pkglibexecdir = $(libexecdir)/collectiblecoincore
...
CONFIG_HEADER = $(top_builddir)/src/config/collectiblecoin-config.h
CONFIG_CLEAN_FILES = libcollectiblecoinconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libcollectiblecoinconsensus.pc.in \
	...
	$(top_srcdir)/src/config/collectiblecoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/davide/Desire/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/davide/Desire/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/davide/Desire/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/davide/Desire/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/davide/Desire/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = collectiblecoincore
PACKAGE_BUGREPORT = https://github.com/collectiblecoinpay/collectiblecoin/issues
PACKAGE_NAME = Collectiblecoin Core
PACKAGE_STRING = Collectiblecoin Core 0.12.2
PACKAGE_TARNAME = collectiblecoincore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/davide/Desire
abs_srcdir = /home/davide/Desire
abs_top_builddir = /home/davide/Desire
abs_top_srcdir = /home/davide/Desire
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/davide/Desire/build-aux/install-sh
...
pkgconfig_DATA = libcollectiblecoinconsensus.pc
BITCOIND_BIN = $(top_builddir)/src/collectiblecoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/collectiblecoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/collectiblecoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Collectiblecoin-Qt.app
OSX_DMG = Collectiblecoin-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_collectiblecoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_collectiblecoin_coverage.info test_collectiblecoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Collectiblecoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/collectiblecoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/collectiblecoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/collectiblecoin-config.h
$(top_srcdir)/src/config/collectiblecoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/collectiblecoin-config.h src/config/stamp-h1
libcollectiblecoinconsensus.pc: $(top_builddir)/config.status $(srcdir)/libcollectiblecoinconsensus.pc.in
...
$(OSX_APP)/Contents/MacOS/Collectiblecoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Collectiblecoin-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "Collectiblecoin-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Collectiblecoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_collectiblecoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_collectiblecoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_collectiblecoin_filtered.info: test_collectiblecoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_collectiblecoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_collectiblecoin_filtered.info
...
#test_collectiblecoin_coverage.info: baseline_filtered_combined.info test_collectiblecoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_collectiblecoin_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_collectiblecoin_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_collectiblecoin_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_collectiblecoin.coverage/.dirstamp:  test_collectiblecoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_collectiblecoin.coverage/.dirstamp total.coverage/.dirstamp

# Collectiblecoin: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_collectiblecoin.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
