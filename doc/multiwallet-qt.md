...
Only requiring some minor changes is collectiblecoin.cpp.
...
Changes to collectiblecoin.cpp
----------------------
collectiblecoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
