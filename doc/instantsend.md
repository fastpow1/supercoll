...
This mechanism has been integrated into Bitcore-Node-Collectiblecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/collectiblecoinpay/insight-api-collectiblecoin#web-socket-api](https://github.com/collectiblecoinpay/insight-api-collectiblecoin#web-socket-api)
* API: [https://github.com/collectiblecoinpay/insight-api-collectiblecoin#instantsend-transactions](https://github.com/collectiblecoinpay/insight-api-collectiblecoin#instantsend-transactions)
...
By default, the Collectiblecoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Collectiblecoin Core daemon:
