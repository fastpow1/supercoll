...
Collectiblecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9919.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9918 for connections and services them.
...
However, in open source software such as Collectiblecoin Core, where everyone uses
...
pay attention to for reviewers of Collectiblecoin Core code.

General Collectiblecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Collectiblecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
