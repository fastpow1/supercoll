...
// writing out the same function for each collectiblecoind number of arguments.  To make
...
// collectiblecoind user defined function with n arguments.  To generate all 16 user
