...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CollectiblecoinNetwork") type = CollectiblecoinNetwork;
    if(strType == "CollectiblecoinNetworkVariable") type = CollectiblecoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CollectiblecoinNetwork) s = "CollectiblecoinNetwork";
    if(type == CollectiblecoinNetworkVariable) s = "CollectiblecoinNetworkVariable";
