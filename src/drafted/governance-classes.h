 ...
 *
 *   // network
 *   CCollectiblecoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.collectiblecoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCollectiblecoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCollectiblecoinNetwork(UniValue objIn)
    {
...
// // can be under: CollectiblecoinNetwork
// //   -- signature requirements : Key1(User)
// class CCollectiblecoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == CollectiblecoinNetwork);
//     // }
