    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Collectiblecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Collectiblecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and collectiblecoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Collectiblecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Collectiblecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Collectiblecoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Collectiblecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Collectiblecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a collectiblecoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Collectiblecoin Core help message to get a list with possible Collectiblecoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Collectiblecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Collectiblecoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Collectiblecoin Core"); // default title
    ...
    // Append title to "Collectiblecoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
