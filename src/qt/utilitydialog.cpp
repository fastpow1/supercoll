    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Collectiblecoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Collectiblecoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  collectiblecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Collectiblecoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 COLL, 0.1 COLL, 1 COLL and 10 COLL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://collectiblecoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://collectiblecoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Collectiblecoin Core is shutting down...") + "<br /><br />" +
