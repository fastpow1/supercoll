...
2. run collectiblecoind with -printalert or -sendalert like this:
   /path/to/collectiblecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.collectiblecoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Collectiblecoin Core:0.12.0.58/"));
