...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Collectiblecoin Core collectiblecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  collectiblecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded collectiblecoin transaction") + "\n" +
              "  collectiblecoin-tx [options] -create [commands]   " + _("Create hex-encoded collectiblecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded collectiblecoin transaction
