/* src/config/collectiblecoin-config.h.  Generated from collectiblecoin-config.h.in by configure.  */
/* src/config/collectiblecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DESIRE_CONFIG_H

#define DESIRE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/collectiblecoinpay/collectiblecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Collectiblecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Collectiblecoin Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "collectiblecoincore"
